...
if estado_jogo = 0 {
	draw_text(mensagem_titulo_x,mensagem_titulo_y,$"teste de pareamento\n\nclique para jogar!")
}
...
if estado_jogo = 3 {
	draw_text(mensagem_acerto_x,mensagem_acerto_y,"resposta certa!")
}

if estado_jogo = 4 {
	draw_text(mensagem_erro_x,mensagem_erro_y,"resposta errada!")
}
